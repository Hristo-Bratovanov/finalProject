...
class ProfileDetailsView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        projects_with_likes = self.object.projects_set.annotate(likes_count=Count('likes'))

        context['total_likes_count'] = sum(photo.likes_count for photo in projects_with_likes)
        context['total_professionals_count'] = self.object.proffesional_set.count()
